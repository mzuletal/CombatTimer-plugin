		...
		TaskID = sh.scheduleSyncRepeatingTask(plugin, new Runnable() 
		{
			public void run()
			{
				if(time == 0)
				{
					...
					entity.sendMessage(ChatColor.translateAlternateColorCodes('&',"&cYou have left combat"));
				...
				{ 
					entity.sendMessage(ChatColor.translateAlternateColorCodes('&', "&cTime Left: &f"+time));
					time--;
				}
			}
		}, 0L, 20);
